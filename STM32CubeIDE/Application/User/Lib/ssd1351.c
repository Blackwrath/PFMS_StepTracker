...
//Re-implementation of https://github.com/afiskon/stm32-ssd1351/blob/master/Lib/ssd1351/ssd1351.c
//From main.h:
...
void SSD1351_Init() {
    ...
    SSD1351_WriteCommand(0xB6); // PRECHARGE3
        {
            uint8_t data[] = { 0x17 };
            SSD1351_WriteData(data, sizeof(data));
        }
...
//    SSD1351_WriteCommand(0xB2); //DISPLAY ENHANCE
//    {
//            uint8_t data[] = { 0xA4, 0x00, 0x00 };
//            SSD1351_WriteData(data, sizeof(data));
//    }
